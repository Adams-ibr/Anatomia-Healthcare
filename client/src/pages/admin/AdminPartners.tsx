...
import { type Partner, insertPartnerSchema } from "@shared/schema";
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Manage partners, sponsors and affiliate links.</p>
        </div>
          ...
          <TableBody>
            ...
            {partners?.map((partner) => (
              <TableRow key={partner.id}>
                ...
                <TableCell>
                    {partner.websiteUrl && <a href={partner.websiteUrl} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{partner.websiteUrl}</a>}
                </TableCell>
                <TableCell>
                  <span className={`px-2 py-1 rounded-full text-xs font-semibold ${partner.isActive ? "bg-green-500/20 text-green-500" : "bg-red-500/20 text-red-500"}`}>
