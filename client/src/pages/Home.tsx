        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full text-center">
            ...
            >
              ...
              >
                Master the Human Body <br />
                in <span className="text-primary italic">Every Dimension</span>
              </motion.h1>
              ...
              >
                Anatomia MedTech is simplifying Anatomy Education through Digital Innovation<br />
                Precision. Innovation. Accessibility
              </motion.p>
                    ...
                    <DialogContent className="sm:max-w-md bg-slate-900 border-white/10 text-white">
                      <DialogHeader>
                        ...
                        <DialogDescription className="text-slate-400 text-center">
                          Sign up to be the first to experience our 3D Interactive Models and VR Simulations.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="py-6">
                        <WaitlistForm />
